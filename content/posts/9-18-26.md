+++ 
draft = false
date = 2026-09-18T01:41:34-06:00
title = "When the Debugger Lies"
slug = "when-the-debugger-lies"
tags = []
categories = []
+++

I've spent the last few weeks working with the security architecture of the
[nRF54L series](https://www.nordicsemi.com/Products/nRF54LM20B) from [Nordic
Semiconductor](https://www.nordicsemi.com/) (in case you missed it, I [recently
joined Nordic](https://danielmangum.com/posts/farewell-golioth-hello-nordic/)!).
...
TrustZone](https://www.arm.com/technologies/trustzone-for-cortex-m) support in
the [Cortex-M33
core](https://danielmangum.com/posts/arm-cortex-m-security-state-gdb/), a
[CRACEN cryptographic
accelerator](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/cracen.html),
and a [Key Management Unit
(KMU)](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html). The
...
(SICR)](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/sicr.html).
...
drivers](http://danielmangum.com/posts/psa-crypto-portability/) are implemented
to abstract the generation, storage, and usage of keys. For example, if
[invoking
`psa_generate_key()`](https://arm-software.github.io/psa-api/crypto/1.1/api/keys/management.html#c.psa_generate_key),
the operation eventually results in a [call to
`import_key_for_kmu()`](https://github.com/nrfconnect/sdk-nrf/blob/b19bcf262862cb85140282dfd44dbe542d34cbc9/subsys/nrf_security/src/drivers/cracen/cracenpsa/src/cracen_psa_key_management.c#L90-L124)
in the [CRACEN PSA
driver](https://github.com/nrfconnect/sdk-nrf/tree/b19bcf262862cb85140282dfd44dbe542d34cbc9/subsys/nrf_security/src/drivers/cracen/cracenpsa).
...
[datasheet](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-concept_key_slot_states)
includes a helpful diagram of the state machine.

{{< center-img src="../../static/debugger_lies_0.png" alt="debugger-lies-0" >}}
...
datasheet](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-concept_provision),
but it can also be seen in the [`cracen_kmu_key_slot_provision()`
implementation](https://github.com/nrfconnect/sdk-nrf/blob/b19bcf262862cb85140282dfd44dbe542d34cbc9/subsys/nrf_security/src/drivers/cracen/cracenpsa/src/cracen_psa_kmu.c#L267-L279):
...
(HAL)](https://github.com/zephyrproject-rtos/hal_nordic/blob/4387c79cebd31927fb1ea7d64bee11728ae8041f/nrfx/drivers/include/nrfx_kmu.h#L75-L88).
...
KMU
sample](https://github.com/nrfconnect/sdk-nrf/tree/b19bcf262862cb85140282dfd44dbe542d34cbc9/samples/crypto/kmu_cracen_usage),
...
meaning](https://github.com/nrfconnect/sdk-nrf/blob/b19bcf262862cb85140282dfd44dbe542d34cbc9/subsys/nrf_security/src/drivers/cracen/cracenpsa/src/cracen_psa_kmu.c#L77-L85)
to each of the bits.
...
DK](https://www.nordicsemi.com/Products/Development-hardware/nRF54LM20-DK) with
an
[`ERASEALL`](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/ctrl-ap.html-ctrlap_erase)
operation on the [control access port
(CTRL-AP)](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/ctrl-ap.html),
I had powered up the board and connected with
[GDB](https://en.wikipedia.org/wiki/GNU_Debugger). As previously mentioned, the
KMU can only be accessed in secure mode. However, when [access port protection
is not
enabled](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/debug.html-access_port_protection),
the [Secure Privileged Invasive Debug Enable
(SPIDEN)](https://support.arm.com/documentation/ddi0309/f/Debug-Architecture/External-debug-interface/SPIDEN)
signal is driven high, and the [on-board J-Link debugger (J-Link
OB)](https://www.segger.com/products/debug-probes/j-link/models/j-link-ob/) can
...
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.status)
(`0x50049400`).
...
[provisioning](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-concept_provision)
and
[push](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-concept_push)
...
[`SRC`
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.src)
(`0x50049504`) and specify the desired key slot (`9`) in the [`KEY_SLOT`
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.keyslot)
(`0x50049500`).
...
(RRAMC)](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/rramc.html)
must be configured to allow unbuffered writes. I stored the current RRAMC
[`CONFIG`
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/rramc.html-register.config)
...
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.tasks_provision)
...
[`EVENTS_PROVISIONED`
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.events_provisioned)
(`0x50049100`).
...
driver's](https://github.com/nrfconnect/sdk-nrf/blob/a653b8d3d4a7eb695350f10bc48b4f2fcb39652a/subsys/nrf_security/src/drivers/cracen/cracenpsa/src/cracen_psa_kmu.c#L267-L279)
`cracen_kmu_key_slot_provision()` and the underlying
`nrfx_kmu_key_slot_provision()`
[function](https://github.com/zephyrproject-rtos/hal_nordic/blob/2bbc7efdd88e2f89ea1b928cf9862b0bf5415a38/nrfx/drivers/src/nrfx_kmu.c#L188-L208).
...
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.tasks_push)
(`0x50049004`).
...
register](https://docs.nordicsemi.com/r/bundle/ps_nrf54lm20a/page/kmu.html-register.events_pushed)
...
(ADI)](https://support.arm.com/documentation/ihi0031/h), specifically leveraging
the [Arm CoreSight SoC-400](https://support.arm.com/documentation/100536/0302/)
implementation. It has three access ports: two standard
[AHB-AP](https://support.arm.com/documentation/100536/0302/Debug-Access-Port/AHB-AP)
...
coprocessor](https://danielmangum.com/posts/vpr-nordic-risc-v-processor/). The
...
{{< center-img src="../../static/debugger_lies_1.png" alt="debugger-lies-1" >}}
...
command](https://kb.segger.com/J-Link_GDB_Server#ReadMemAP), which allows you to
...
strings](https://kb.segger.com/J-Link_Command_Strings) that gives a clue as to
its internal caching behavior. Specifically, the [`SetEnableMemCache`
command](https://kb.segger.com/J-Link_Command_Strings#SetEnableMemCache) is
