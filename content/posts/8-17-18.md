...
what type of base image (see [this page](https://cloud.google.com/compute/docs/images) for information on the public image library Google Cloud provides) the template will use as well as the 
